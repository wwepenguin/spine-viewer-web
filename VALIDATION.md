...
- 五個主區域可獨立折疊，SVG 箭頭與 aria-expanded 同步，收合內容離開鍵盤焦點順序。
- 瀏覽器驗證全部收合、Enter 展開 Slots、Space 展開 Animations；搜尋文字、walk 動畫與暫停時間保留。
- Clear 操作不會觸發折疊；無 console error。TypeScript 檢查與正式建置通過。
